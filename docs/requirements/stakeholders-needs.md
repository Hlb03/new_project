...
https://edu-db.github.io/p4/4 

https://dou.ua/lenta/articles/use-cases/

https://thepage.ua/ua/experts/mozhut-znadobitisya-yak-biznes-mozhe-vikoristovuvati-vidkriti-dani

https://nachasi.com/tech/2020/04/01/open-data-day-2020/
...
7. Можливе виникнення ECA-Ex-1.2.2

<hr>

***ID:***  Use-Case Administrator (UCA) 1.2

***НАЗВА:*** Видалити права модератора у користувача/модератора
...
***НАЗВА:*** Додавання Dataset Користувача

***УЧАСНИКИ:*** Модератор і система
...
1. Користувач авторизувався в системі
2. Користувач натискає на кнопку “Пошук” і вводить свій запит
3. Система обробляє запит користувача
4. Можливе виникнення UCU-Ex-3.1.1
5. Користувач отримує дані, що задовольняють вимоги
...
Користувач знаходить дані

Користувач натискає кнопку “Перетворити в таблицю”

Система візуалізує дані

Можливе виникнення UCG-Ex-3.2.1

Користувач отримує дані у вигляді таблиці 
...
UCU-Ex-3.3.1 - не вдалося зберегти дані

***ОСНОВНИЙ СЦЕНАРІЙ:*** 

 1. Користувач знаходить дані
2. Користувач натискає на кнопку “Зберегти” та вказує шлях
3. Система обробляє та вивантажує файл
4. Можливе виникнення UCU-Ex-3.3.1
5. Користувач завантажує дані
...
Гість заходить на сайт

Гість натискає кнопку “Зареєструватися”

Гість переходить до вікна реєстрації 

Гість вводить свої дані

Можливе виникнення UCG-Ex-4.1.1, UCG-Ex-4.1.2

Гість зареєстрований на сайті
...
UCG-Ex-4.2.1 - даних за даним запитом не існує
...
Система обробляє запит користувача

Можливе виникнення UCG-Ex-4.2.1

Гість отримує дані, що задовольняють вимоги
...
Гість знаходить дані

Гість натискає кнопку “Перетворити в таблицю”

Система візуалізує дані

Можливе виникнення UCG-Ex-4.3.1

Гість отримує дані у вигляді таблиці
...
Візуалізація — можливість візуалізувати дані, оскільки хоче автор і користувачі, а не оскільки це зробить система.

Стандартизованість – можливість задати структуру даних, відхилення від якої видасть помилку та не дозволить завантажити дані.

API та інтеграція - багатий API та можливість інтеграції з різними джерелами даних.

Соціальність - обговорення, оцінка та рецензування даних спільнотою.

Міжнародність — дані не повинні розміщуватись на серверах у якійсь одній країні, щоб уникнути їхнього блокування з боку держави.
...
https://leally.ru/browsers/skachat-obnovlenie-microsoft-net-framework-ustanavlivaem-ili-obnovlyaem-ispravlyaem/

https://habr.com/ru/post/331036/

https://docs.microsoft.com/ru-ru/archive/msdn-magazine/2011/september/open-data-protocol-build-great-experiences-on-any-device-with-odata
